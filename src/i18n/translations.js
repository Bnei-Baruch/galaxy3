  ...
  en: {
    common: {
      ...
      loginPage: {
        ...
        newUsers: 'New Users',
        guestMessage: 'You can either register or continue using the system as guest.',
        login: 'Login',
        guest: 'Continue as a Guest',
      },
      loginMessage : {
        loginWarning: 'You are using the system as a guest. In order to help us  keep the system secured we kindly ask you to make a registration and start using it safely. If you already did it just click the login button.',
      },
    },
  },
  es: {
    common: {
      ...
      loginPage: {
        ...
        guestMessage: 'Puede registrarse o continuar usando el sistema como invitado.',
        login: 'Ingresar',
        guest: 'Continuar como invitado',
      },
      loginMessage : {
        loginWarning: 'Está usando el sistema como invitado (guest). Para poder ayudarnos a mantener la seguridad del sistema, le solicitamos amablemente que se registre y comience a usarlo de forma segura. Si ya lo ha hecho solo presiona el botón "Ingresar".',
      },
    },
  },
  he: {
    common: {
      ...
      loginPage: {
        ...
        guestMessage: 'אתה יכול להרשם או להמשיך להשתמש במערכת כאורח.',
        login: 'כניסה',
        guest: 'המשך כאורח',
      },
      loginMessage : {
        loginWarning: 'הנך משתמש/ת במערכת כאורח/ת. כדי לעזור לנו לשמור על בטחון המערכת אנחנו מבקשים ממך להרשם ולהתחיל להשתמש במערכת בצורה בטוחה. אם כבר ביצעת הרשמה בעבר אז רק תלחץ על כפתור הכניסה.',
      },
    },
  },
  ru: {
    common: {
      ...
      loginPage: {
        ...
        guestMessage: 'Вы можете зарегистрироваться или продолжить использовать систему в качестве гостя.',
        login: 'Войти',
        guest: 'Продолжить как гость',
      },
      loginMessage : {
        loginWarning: 'Вы используете систему в качестве гостя. Чтобы помочь нам обеспечить безопасность системы, просим вас зарегистрироваться и начать безопасно ее использовать. Если вы уже сделали это просто нажмите на кнопку Войти.',
      },
    },
  },
};
