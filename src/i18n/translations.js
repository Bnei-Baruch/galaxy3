export const resources = {
  ...
  he: {
    common: {
      ...
      onboarding:{
        welcome: "ברוך בואך {{name}}",
        general_note:`מערכת הערבות פעילה עבור משתמשים רשומים בעלי מנוי פעיל.
        על מנת להמשיך יש להשלים את התנאים המופיעים מטה.`,
        email_note: "כתובת הדוא״ל שלך היא: {{email}}.",
        registration: {
          title: "רישום",
          register: "להרשמה",
          status_approved: "ההרשמה שלך הסתיימה בהצלחה. הכל מוכן. תודה.",
        ...
        membership: {
          title: "מנוי",
          statusMessage: "סטטוס המנוי שלך הוא: ",
          statusActive: "פעיל",
          statusInactive:"לא פעיל",
          manage: "להסדרת המנוי",
          activate: "נא להסדיר את המנוי בבית הוירטואלי.",
