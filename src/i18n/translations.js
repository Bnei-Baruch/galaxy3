export const resources = {
  en: {
    common: {
      ...
      galaxyApp: {
        pendingApproval: 'Thank you for registering to Arvut. Your account will be verified in the next few days. You will be able to use the system afterwards.',
        terms: 'Arvut Terms of Use',
        verifyAccount: 'You successfully registered to Arvut. We will need to verify your account with one of your friends. Please provide an email address of a friend that can verify he knows you. If you don’t have such information right now, you will be granted partial guest access.',
        ...
        welcomeGuestPopup: 'Welcome to Arvut. You are now registered as a guest. We will need to verify your account. In the meantime you will be granted partial access permissions: You will be able to join any room, see who is inside and watch the broadcast. You will not be able to participate in the workshops or ask questions during a live lesson. Please help us verify your account as soon as possible by filling out the form at the top of the page.',
        welcomeGuestPopupRequested: 'Welcome to Arvut. A verification request was sent to your friend. In the meantime you will be granted partial access permissions: You will be able to join any room, see who is inside and watch the broadcast. You will not be able to participate in the workshops or ask questions during a live broadcast.',
        approveVerificationHeader: 'Hi [UserFirstName], Your friends ask your verification. If you know them and can verify their email please check them as verified on the list below so they can start using Arvut. If you are not familiar with them check ignore:',
        approveVerificationVerify: 'Verify',
        approveVerificationIgnore: 'Ignore',
        approveVerificationEmail: 'Email',
        requestedVerificationBadEmailPopup: 'The email you entered is not registered to Arvut. Please enter a valid email at the form above.',
        requestedVerificationPopup: 'A verification request was sent to your friend. Upon verification, you will be granted full access to Arvut.',
        ok: 'OK',
        close: 'Close',
        cancel: 'Cancel',
  ...
  es: {
    common: {
      ...
      settings: {
        ...
        broadcastSettings: 'Configuración de la transmisión',
      ...
      galaxyApp: {
        pendingApproval: 'Gracias por registrarte en Arvut. Su cuenta será verificada en los próximos días. Podrá utilizar el sistema después.',
        terms: 'Términos de uso de Arvut',
        close: 'Cerrar',
        verifyAccount: 'Se registro al Arvut con éxito. Necesitamos verificar su cuenta con uno de sus amigos que pueda confirmar que le conoce. Complete a continuación el correo electrónico de un amigo que pueda confirmarlo. Si no tiene esta información, se le dará acceso parcial al sistema.',
        ...
        welcomeGuestPopup: 'Bienvenido a Arvut. Ahora está registrado como invitado. Tendremos que verificar su cuenta. Mientras tanto, se le otorgará permiso de acceso parcial: podrá unirse a cualquier sala, ver quién está adentro y ver la transmisión. No podrá participar en los talleres o hacer preguntas durante una lección en vivo, ayúdenos a verificar su cuenta lo antes posible completando el formulario en la parte superior de la página.',
        welcomeGuestPopupRequested: 'Bienvenido a Arvut. Se envió un mensaje de solicitud, para verificar su cuenta, a su amigo. Hasta que se apruebe, recibirá permiso parcial para el sistema: puede unirse a cualquier sala, ver quién está en la sala y ver la transmisión. No podrá participar en el taller, ni hacer preguntas durante la transmisión en vivo.',
        approveVerificationHeader: 'Hola [UserFirstName],´tus amigos te piden verificación. Si los conoces y puedes verificar su correo electrónico, por favor márcalos como verificados en la lista, para que ellos puedan comenzar a utilizar Arvut. Si no los conoces marca ignorar:',
        approveVerificationVerify: 'Verificar',
        approveVerificationIgnore: 'Ignorar',
        approveVerificationEmail: 'Email',
        requestedVerificationBadEmailPopup: 'El correo electrónico que ingresó no está registrado en Arvut. Ingrese un correo electrónico válido en el formulario de arriba.',
        requestedVerificationPopup: 'Se envió un correo electrónico de verificación a su amigם. Después de la verificación, tendrá acceso completo al sistema Arvut.',
        ok: 'OK',
        cancel: 'Cancel',
      ...
      registration: {
        ...
        needVerifyAccount: 'Te has inscrito exitosamente al sistema Arvut. Para proveerte acceso completo precisamos verificar tu cuenta.',
        tellAboutYou: 'Por favor cuéntanos de ti:',
        asGuestYouCan: 'Como invitado vas a poder ver la transmisión. No podrás participar en los talleres o hacer preguntas en vivo.',
  ...
  he: {
    common: {
      ...
      settings: {
        ...
        broadcastSettings: 'הגדרות צפייה',
  ...
  ru: {
    common: {
      ...
      galaxyApp: {
        pendingApproval: 'Спасибо за регистрацию в Arvut. Ваша учетная запись будет проверена в ближайшие несколько дней. Вы сможете использовать систему впоследствии.',
        verifyAccount: 'Вы успешно записаны в Arvut. Нам необходимо подтвердить Ваш аккаунт  через одного из Ваших товарищей, который знаком с Вами и готов это подтвердить. Запишите, пожалуйста, ниже адрес электронной почты товарища для подтверждения. Если у Вас нет такой информации,  то Вам будет предоставлено частичное использование системы в качестве гостя.',
        ...
        approveVerificationHeader: 'Здравствуйте, [UserFirstName]. Ваши друзья просят Вас подтвердить то, что они вам знакомы. Если знакомы и вы узнаёте их мейл, то отметьте их в колонке "подтвердить" и они смогут начать пользоваться Arvut. А если нет, то отметьте их в колонке "игнорировать":',
        approveVerificationVerify: 'Подтвердить',
        approveVerificationIgnore: 'Игнорировать',
        approveVerificationEmail: 'Эл. почта',
        requestedVerificationBadEmailPopup: 'Адрес электронной почты, который Вы ввели, не зарегистрирован в системе Arvut. Пожалуйста, введите точный адрес электронной почты на верхней части страницы.',
        requestedVerificationPopup: 'Вашему товарищу выслано сообщение  с просьбой о подтверждении. После подтверждения Вы получите полный доступ к системе Arvut.',
        ok: 'Применить',
        cancel: 'Отменить',
      ...
      registration: {
        ...
        needVerifyAccount: 'Вы успешно зарегистрировались в системе Арвут. Чтобы предоставить вам полный доступ, нам необходимо будет подтвердить вашу учетную запись.',
        tellAboutYou: 'Расскажите, пожалуйста, о себе:',
        asGuestYouCan: 'В качестве гостя вы сможете смотреть трансляцию. Вы не сможете участвовать в семинарах или задавать вопросы в прямом эфире.',
