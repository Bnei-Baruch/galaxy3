  ...
  es: {
    common: {
      ...
      galaxyApp: {
        ...
        verifyAccount: 'Se registro al Galaxy con éxito. Necesitamos verificar su cuenta con un@ de sus amig@s que pueda confirmar que le conoce. Complete a continuación el correo electrónico de un amig@ que pueda confirmarlo. Si no tiene esta información, se le dará acceso parcial al sistema.',
				typeFriendEmail: 'Escriba el correo electonico de su amig@',
        welcomeGuestForm: 'Actualmente está registrad@ como invitad@. Para obtener acceso completo, debemos verificar su cuenta. Complete la dirección de correo electrónico de un amig@ que pueda verificar que l@ conoce.',
				welcomeGuestPopup: 'Bienvenid@ a Galaxy. Ahora está registrad@ como invitad@. Tendremos que verificar su cuenta. Mientras tanto, se le otorgará permiso de acceso parcial: podrá unirse a cualquier sala, ver quién está adentro y ver la transmisión. No podrá participar en los talleres o hacer preguntas durante una lección en vivo, ayúdenos a verificar su cuenta lo antes posible completando el formulario en la parte superior de la página.',
        welcomeGuestPopupRequested: 'Bienvenid@ a Galaxy. Se envió un mensaje de solicitud, para verificar su cuenta, a su amig@. Hasta que se apruebe, recibirá permiso parcial para el sistema: puede unirse a cualquier sala, ver quién está en la sala y ver la transmisión. No podrá participar en el taller, ni hacer preguntas durante la transmisión en vivo.',
        ...
        requestedVerificationPopup: 'Se envió un correo electrónico de verificación a su amig@. Después de la verificación, tendrá acceso completo al sistema Galaxy.',
        ok: 'OK',
        close: 'Close',
        cancel: 'Cancel',
  ...
  ru: {
    common: {
      ...
      galaxyApp: {
        ...
        approveVerificationHeader: 'Здравствуйте, [имя]. Ваши друзья просят Вас подтвердить то, что они вам знакомы. Если знакомы и вы узнаёте их мейл, то отметьте их в колонке "подтвердить" и они смогут начать пользоваться Galaxy. А если нет, то отметьте их в колонке "игнорировать":',
