  ...
  he: {
    common: {
      ...
      galaxyApp: {
        ...
        close: 'סגור',
        verifyAccount: 'נרשמת לערבות בהצלחה . עלינו לאמת את חשבונך עם אחד החברים שלך שיוכל לאשר שהוא מכיר אותך. אנא מלא למטה כתובת דואר אלקטרוני של חבר שיוכל לאשר אותך. אם אין לך מידע זה, תינתן לך גישה חלקית של אורח למערכת.',
        ...
        welcomeGuestPopup: 'ברוך הבא לערבות. אתה רשום במערכת כאורח. עד האישור תקבל הרשאות גישה חלקיות: תוכל להצטרף לכל חדר, לראות מי נמצא בחדר ולצפות בשידור. לא תוכל להשתתף בסדנא או לשאול שאלות במהלך השיעור החי. אנא עזור לנו לאמת את חשבונך בהקדם האפשרי על ידי מילוי הטופס בראש העמוד.',
        welcomeGuestPopupRequested: 'ברוך הבא לערבות. הודעה עם בקשה לאימות חשבונך נשלחה לחבר שלך . עד האישור, תקבל הרשאות חלקיות למערכת: תוכל להצטרף לכל חדר, לראות מי נמצא בחדר ולצפות בשידור. לא תוכל להשתתף בסדנא או לשאול שאלות במהלך השידור החי.',
        approveVerificationHeader: 'שלום [UserFirstName], חבריך מבקשים שתאמת את ההיכרות איתם. אם אתה מכיר אותם ויכול לאמת את כתובת הדואר האלקטרוני שלהם, אנא סמן אותם כמאומתים ברשימה למטה כדי שיוכלו להתחיל להשתמש בערבות. אם אינך מכיר אותם סמן ברשימה התעלם:',
        approveVerificationVerify: 'אשר',
        approveVerificationIgnore: 'התעלם',
        approveVerificationEmail: 'דואר אלקטרוני',
        requestedVerificationBadEmailPopup: 'כתובת הדואר האלקטרוני שהזנת אינו רשום בערבות. אנא הזן כתובת דואר אלקטרוני תקין בטופס שלמעלה.',
