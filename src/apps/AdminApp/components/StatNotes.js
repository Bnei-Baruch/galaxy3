...
class StatNotes extends Component {
    ...
    render() {
        const {gxy1_count, gxy2_count, gxy3_count, gxy4_count, gxy5_count, gxy6_count, gxy7_count, gxy8_count,
          gxy9_count, gxy10_count, gxy11_count, str1_count, str2_count, str3_count, str4_count, str5_count,
          str6_count, str7_count, str8_count, str9_count, str10_count, str11_count, gxy_sum, str_sum} = this.state;
