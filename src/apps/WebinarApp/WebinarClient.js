...
import VirtualStreaming from "./WebinarStreaming";
...
class WebinarClient extends Component {
  constructor(props) {
    super(props);
...
WebinarClient.contextType = GlobalOptionsContext
const WrappedClass = withTranslation()(WebinarClient);
