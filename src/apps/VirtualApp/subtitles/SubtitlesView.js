...
export const SubtitlesView = ({msgState}) => {
      ...
      <Dropdown.Item className="manage-font-size">
        <div
          className={classNames("manage-font-size-pop__container",
							{ltr: !isLtr /* Opposite of read direction. */ })}
        ...
        >
          <div className="manage-font-size-pop__context">
            ...
            <Slider
              ...
              onChange={(v) => {
								if (v >= -4 && v <= 4) {
									// This will have a nice span effect while dragging the slider.
									v = 0;
								}
                setSlideSize(v);
  ...
  const renderSettings = () => {
    return (
      <div className={classNames("wq__toolbar", {rtl: !isLtr})}>
        <Dropdown
    ...
    <div className={classNames("wq-overlay", "overlay-visible", {"is-link": isLink})}>
      { isLink ? (
        ...
        <div className="wq-container">
          ...
          <div className={classNames("show-wq", {"overlay-visible": !showQuestion, ltr: isLtr})}>
